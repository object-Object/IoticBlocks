...
abstract class IoticBlocksModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<IoticBlocksModDependenciesExtension>("ioticblocksModDependencies")
